...
<![endif]-->
    ...
    <head>
        ...
        <meta name="description" content="{{ isset($meta_desc) ? $meta_desc : 'pink' }}" />
        <meta name="keywords" content="{{ isset($keywords) ? $keywords : 'pink' }}" />
        ...
        <link rel="icon" type="{{ asset(config('settings.theme')) }}/image/x-icon" href="images/favicon.ico" />
    ...
    <!-- START BODY -->
    <body class="no_js responsive {{ (Route::currentRouteName() == 'home' || Route::currentRouteName() == 'portfolio.index' || Route::currentRouteName() == 'portfolio.show') ? 'page-template-home-php' : ''}} stretched">
