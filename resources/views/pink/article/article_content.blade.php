<div id="content-single" class="content group">
    <div class="hentry hentry-post blog-big group ">
        ...
        <div class="meta group">
            ...
            <p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) }} {{ Lang::choice('ru.comments', count($article->comments)) }}</a></span></p>
        </div>
        <!-- post content -->
    ...
    <div id="comments">
        ...
        <ol class="commentlist group">
        	...
        	@foreach ($com as $k => $comments)
        		...
        		@include(config('settings.theme').'.article.comment', ['items'=>$comments])
        	@endforeach	
        </ol>
        ...
        <div id="respond">
            <h3 id="reply-title">Leave a <span>Reply</span> <small><a rel="nofollow" id="cancel-comment-reply-link" href="#respond" style="display:none;">Cancel reply</a></small>
            </h3>
            <form action="{{ route('comment.store') }}" method="POST" id="commentform">
                ...
                <p class="comment-form-comment">
                	...
                	<textarea id="text" name="text" cols="45" rows="8"></textarea></p>
                <div class="clear"></div>
                <p class="form-submit">

                	<input id="{{ $article->id }}" type="hidden" name="comment_post_ID" value="{{ $article->id }}">
